      ...
      <div className="w-full bg-black text-white overflow-hidden">
        ...
        >
          ...
          <motion.div
            ...
            style={{ backgroundImage: "url('/images/fit-out/hero-bg.png')" }}
        ...
        {/* ------------------ ABOUT FITOUT ------------------ */}
        <section className="py-16 md:py-20 px-4 md:px-6 max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">
          <motion.div initial="hidden" whileInView="visible" variants={fadeUp}>
            <h2 className="text-3xl md:text-4xl font-bold text-red-600 mb-6">
              Professional Fit-Out Services
            </h2>
            <p className="text-gray-300 leading-relaxed mb-4 text-base md:text-lg">
              Gulf Fixit fit-out services are designed to transform interior and exterior
              spaces into functional & visually appealing environments tailored to your
              unique needs.
            </p>
            <p className="text-gray-300 leading-relaxed mb-4 text-base md:text-lg">
              From concept to completion, we manage every detail with high standards of
              design, materials and craftsmanship.
            </p>
            <p className="text-gray-300 leading-relaxed text-base md:text-lg">
              We specialize in space planning, interior design, construction and project
              management to deliver cost-effective, timely and stunning results.
            </p>
          </motion.div>
