...
export default function ServicesPage() {
  ...
  return (
    <>
      {/* SEO HEAD */}
      <Head>
        <title>Services | Gulf Fixit Dubai</title>
        <meta
          name="description"
          content="Explore Gulf Fixit services: MEP, interior fit-outs, painting, carpentry, HVAC, electrical, plumbing, handyman, partitions & more across Dubai."
        />
        <link rel="canonical" href="https://www.gulffixit.com/services" />
      </Head>
