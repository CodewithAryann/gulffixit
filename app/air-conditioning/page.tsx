      ...
      <div className="w-full bg-black text-white overflow-hidden">
        ...
        >
          <motion.div
            ...
            style={{ backgroundImage: "url('/images/services/ac.png')" }}
          ...
          >
            ...
            <p className="mt-3 text-lg md:text-2xl text-gray-200 font-light">
              Professional Installation, Repair & Maintenance Across Dubai
            </p>
          </motion.div>
        </motion.section>
        ...
        <section className="py-20 bg-white text-black relative overflow-hidden px-4">
          ...
          >
            Reach out for air conditioning installation, repair, or maintenance — our certified technicians will assist you promptly.
          </motion.p>
